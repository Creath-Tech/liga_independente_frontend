  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        decoration: BoxDecoration(
            color: boxColorHeader, borderRadius: BorderRadius.circular(30)),
        height: 40,
        child: Row(
          ...
          children: [
            ...
            Expanded(
              child: TextField(
                // inputFormatters:
                //  icon == 'whatsapp' ? [PhoneInputFormatter()] : [],
                keyboardType: icon == 'whatsapp'
                    ? TextInputType.phone
                    : TextInputType.url,
                ...
                decoration: InputDecoration(
                  ...
                  hintText: icon == 'whatsapp'
                      ? '(xx) x xxxx-xxxx'
                      : 'Insira a url do seu perfil',
